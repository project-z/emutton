/**
 * All Awesomeness included in this file is thanks to Zed Shaw and Zed's
 * Awesome Debug Macros from Learn C the Hard Way.  Thanks Zed - I'll get you
 * my first-born child once that happens...
 */
#ifndef __dbg_h__
#define __dbg_h__
